...
html, body { background: #fdf8f0 !important; }
.stApp, [data-testid="stAppViewContainer"], [data-testid="stMain"], [data-testid="stMainBlockContainer"], section[data-testid="stSidebar"], .main {
    background: #fdf8f0 !important;
    background-image: radial-gradient(ellipse 80% 50% at 20% 10%, rgba(201,168,76,0.08) 0%, transparent 60%), radial-gradient(ellipse 60% 40% at 80% 90%, rgba(180,140,60,0.06) 0%, transparent 60%) !important;
    color: #2a2010; font-family: 'Crimson Pro', Georgia, serif;
}

#MainMenu, footer, header, .stDeployButton { visibility: hidden !important; }
.block-container { padding: 1.5rem 2.5rem 4rem !important; max-width: 1400px !important; }

.stMarkdown p, .stMarkdown li { font-family: 'Crimson Pro', serif; font-size: 1.05rem; line-height: 1.75; color: #3a3020; }
h1, h2, h3 { font-family: 'Cinzel', serif !important; color: #7a5a10 !important; }

.vault-hero { text-align: center; padding: 2.5rem 2rem 1.8rem; position: relative; margin-bottom: 0.5rem; }
.vault-hero::before { content: ''; position: absolute; top: 0; left: 50%; transform: translateX(-50%); width: 320px; height: 1px; background: linear-gradient(90deg, transparent, #c9a84c, transparent); }
.vault-hero::after { content: ''; position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); width: 520px; height: 1px; background: linear-gradient(90deg, transparent, #c9a84c66, transparent); }
.vault-title { font-family: 'Cinzel', serif; font-size: 3rem; font-weight: 900; letter-spacing: 0.12em; background: linear-gradient(135deg, #f5e17a 0%, #c9a84c 40%, #e8c96a 70%, #b08830 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; margin: 0; line-height: 1.1; }
.vault-subtitle { font-family: 'Crimson Pro', serif; font-style: italic; font-size: 1.1rem; color: #6a5530; letter-spacing: 0.2em; margin-top: 0.4rem; }
.vault-time { font-family: 'JetBrains Mono', monospace; font-size: 0.76rem; color: #7a6e52; letter-spacing: 0.15em; margin-top: 0.7rem; text-transform: uppercase; }

.stat-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 1rem; margin: 1.5rem 0 2rem; }
.stat-card { background: linear-gradient(135deg, #f5ead8 0%, #ede0c4 100%); border: 1px solid #d4c09a; border-top: 2px solid var(--accent, #c9a84c); border-radius: 6px; padding: 1.2rem 1.4rem 1rem; position: relative; overflow: hidden; transition: transform 0.2s ease, box-shadow 0.2s ease; }
.stat-card:hover { transform: translateY(-2px); box-shadow: 0 6px 24px rgba(201,168,76,0.12); }
.stat-icon { font-size: 1.5rem; margin-bottom: 0.3rem; display: block; }
.stat-label { font-family: 'Cinzel', serif; font-size: 0.58rem; letter-spacing: 0.25em; text-transform: uppercase; color: #7a6e52; margin-bottom: 0.2rem; }
.stat-value { font-family: 'Cinzel', serif; font-size: 1.7rem; font-weight: 700; color: var(--accent, #c9a84c); line-height: 1; }
.stat-sub { font-family: 'Crimson Pro', serif; font-size: 0.82rem; color: #9a8050; margin-top: 0.2rem; font-style: italic; }

.section-divider { display: flex; align-items: center; gap: 1rem; margin: 2rem 0 1.5rem; }
.section-divider::before, .section-divider::after { content: ''; flex: 1; height: 1px; background: linear-gradient(90deg, transparent, #4a3e28, #4a3e28, transparent); }
.section-title { font-family: 'Cinzel', serif; font-size: 0.68rem; letter-spacing: 0.35em; text-transform: uppercase; color: #c9a84c; white-space: nowrap; }

.stForm { background: linear-gradient(160deg, #f8f0e0 0%, #f2e8d0 100%) !important; border: 1px solid #d4c09a !important; border-radius: 6px !important; padding: 1.5rem !important; }
.form-section-head { font-family: 'Cinzel', serif; font-size: 0.63rem; letter-spacing: 0.4em; text-transform: uppercase; color: #c9a84c; padding: 0.4rem 0; border-bottom: 1px solid #3a3020; margin: 1.5rem 0 1rem; }

.stNumberInput input, .stTextInput input, .stTimeInput input { background: #faf4e8 !important; border: 1px solid #d4c09a !important; border-radius: 3px !important; color: #2a2010 !important; font-family: 'JetBrains Mono', monospace !important; font-size: 0.9rem !important; }
.stNumberInput input:focus, .stTextInput input:focus { border-color: #c9a84c !important; box-shadow: 0 0 0 2px rgba(201,168,76,0.2) !important; }
.stCheckbox label { color: #3a3020 !important; font-family: 'Crimson Pro', serif !important; font-size: 1.02rem !important; }

.stSelectbox label, .stNumberInput label, .stTextInput label, .stTimeInput label, div[data-testid="stWidgetLabel"] p { font-family: 'Crimson Pro', serif !important; font-size: 0.97rem !important; color: #5a4a20 !important; }

.stButton > button { background: linear-gradient(135deg, #f0e8d0 0%, #e8dcc0 100%) !important; border: 1px solid #5a4a28 !important; border-radius: 3px !important; color: #7a5a10 !important; font-family: 'Cinzel', serif !important; font-size: 0.72rem !important; letter-spacing: 0.15em !important; text-transform: uppercase !important; padding: 0.6rem 1rem !important; transition: all 0.2s ease !important; width: 100% !important; }
.stButton > button:hover { background: linear-gradient(135deg, #3a2e18 0%, #4a3a1a 100%) !important; border-color: #c9a84c !important; box-shadow: 0 0 18px rgba(201,168,76,0.18) !important; color: #f0dc88 !important; transform: translateY(-1px) !important; }
[data-testid="stFormSubmitButton"] > button { background: linear-gradient(135deg, #302412 0%, #45350e 50%, #302412 100%) !important; border: 1px solid #c9a84c !important; color: #f5e17a !important; font-size: 0.82rem !important; padding: 0.8rem 2rem !important; letter-spacing: 0.25em !important; box-shadow: 0 0 25px rgba(201,168,76,0.12) !important; margin-top: 1rem !important; }
[data-testid="stFormSubmitButton"] > button:hover { background: linear-gradient(135deg, #45350e 0%, #60480f 50%, #45350e 100%) !important; box-shadow: 0 0 35px rgba(201,168,76,0.22) !important; }

.stTabs [data-baseweb="tab-list"] { background: transparent !important; border-bottom: 1px solid #3a3020 !important; gap: 0 !important; }
.stTabs [data-baseweb="tab"] { background: transparent !important; border: none !important; color: #7a6a48 !important; font-family: 'Cinzel', serif !important; font-size: 0.68rem !important; letter-spacing: 0.18em !important; text-transform: uppercase !important; padding: 0.8rem 1.4rem !important; border-bottom: 2px solid transparent !important; transition: all 0.2s !important; }
...
.stExpander { background: #f8f2e4 !important; border: 1px solid #d4c09a !important; border-radius: 4px !important; }
...
[data-testid="metric-container"] { background: linear-gradient(135deg, #f5ead8 0%, #ede0c4 100%) !important; border: 1px solid #d4c09a !important; border-top: 2px solid #c9a84c !important; border-radius: 4px !important; padding: 1rem !important; }
...
.stInfo { background: rgba(201,168,76,0.07) !important; border: 1px solid #4a3e28 !important; border-left: 3px solid #c9a84c !important; color: #cfc090 !important; font-family: 'Crimson Pro', serif !important; font-size: 1rem !important; }
.stSuccess { background: rgba(80,160,80,0.1) !important; border: 1px solid #2a4a2a !important; border-left: 3px solid #5aaa5a !important; color: #9ada9a !important; font-family: 'Crimson Pro', serif !important; }
.stError { background: rgba(200,70,70,0.1) !important; border: 1px solid #4a2020 !important; border-left: 3px solid #aa4a4a !important; color: #d49090 !important; font-family: 'Crimson Pro', serif !important; }
.stWarning { background: rgba(200,150,40,0.1) !important; border: 1px solid #4a3010 !important; border-left: 3px solid #aa8030 !important; color: #d4b070 !important; font-family: 'Crimson Pro', serif !important; }

.stDataFrame { border: 1px solid #d4c09a !important; border-radius: 4px !important; }
[data-testid="stDataFrame"] th { background: #221e16 !important; font-family: 'Cinzel', serif !important; font-size: 0.63rem !important; letter-spacing: 0.12em !important; color: #6a5530 !important; border-bottom: 1px solid #3a3020 !important; }
[data-testid="stDataFrame"] td { font-family: 'JetBrains Mono', monospace !important; font-size: 0.8rem !important; color: #3a3020 !important; background: #f0e8d4 !important; }

.shop-item { background: linear-gradient(160deg, #f8f0e0, #f0e8d0); border: 1px solid #d4c09a; border-radius: 6px; padding: 1rem 0.8rem 0.7rem; text-align: center; margin-bottom: 0.5rem; transition: all 0.2s; }
...
.shop-item-name { font-family: 'Crimson Pro', serif; font-size: 0.95rem; color: #d4c49a; display: block; margin-bottom: 0.25rem; font-weight: 600; }
.shop-item-price { font-family: 'JetBrains Mono', monospace; font-size: 0.72rem; color: #c9a84c; }

.tier-badge { display: inline-block; font-family: 'Cinzel', serif; font-size: 0.6rem; letter-spacing: 0.2em; text-transform: uppercase; padding: 0.2rem 0.8rem; border-radius: 2px; margin-bottom: 1rem; }
...
.ach-card { display: flex; align-items: flex-start; gap: 0.8rem; padding: 0.9rem 1rem; background: #f8f2e4; border: 1px solid #2a2418; border-radius: 5px; margin-bottom: 0.5rem; transition: all 0.2s; }
...
.inv-item { display: flex; justify-content: space-between; align-items: center; padding: 0.7rem 1rem; background: #f8f2e4; border: 1px solid #2a2418; border-left: 3px solid #c9a84c; border-radius: 3px; margin-bottom: 0.4rem; font-family: 'Crimson Pro', serif; color: #d4c49a; font-size: 1rem; }
.inv-count { font-family: 'JetBrains Mono', monospace; font-size: 0.72rem; background: rgba(201,168,76,0.12); color: #c9a84c; padding: 0.15rem 0.5rem; border-radius: 2px; }

.ledger-group { border: 1px solid #d4c09a; border-radius: 6px; overflow: hidden; margin-bottom: 1rem; }
.ledger-group-header { background: linear-gradient(135deg, #ede0c4, #e4d4b0); padding: 0.6rem 1rem; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #3a3020; }
.ledger-group-date { font-family: 'JetBrains Mono', monospace; font-size: 0.75rem; color: #6a5530; letter-spacing: 0.1em; }
.ledger-group-net { font-family: 'Cinzel', serif; font-size: 0.8rem; font-weight: 700; letter-spacing: 0.05em; }
.ledger-group-net.pos { color: #6ac878; }
.ledger-group-net.neg { color: #d47070; }
.ledger-row { display: flex; justify-content: space-between; align-items: center; padding: 0.45rem 1rem 0.45rem 1.4rem; border-bottom: 1px solid #272015; font-family: 'Crimson Pro', serif; font-size: 0.95rem; }
.ledger-row:last-child { border-bottom: none; }
.ledger-row:hover { background: rgba(201,168,76,0.04); }
.ledger-cat { color: #3a2a10; flex: 1; }
.ledger-pts { font-family: 'JetBrains Mono', monospace; font-size: 0.8rem; font-weight: 600; min-width: 64px; text-align: right; }
.ledger-pts.earn  { color: #6ac878; }
.ledger-pts.pen   { color: #d47070; }
.ledger-pts.zero  { color: #5a5038; }
.ledger-pts.stars { color: #f5d060; }
.ledger-balance-row { display: flex; justify-content: flex-end; align-items: center; gap: 0.6rem; padding: 0.4rem 1rem; background: #ede4cc; font-family: 'JetBrains Mono', monospace; font-size: 0.72rem; color: #7a6a48; }
...
def check_achievements():
    ...
    tier3 = set(VIRTUAL_SHOP["Tier 3 (Rare)"].keys())
...
if submit_log:
    ...
    st.session_state["last_log_result"] = {
        "earned": total_earned, "penalty": total_penalty, "net": net_points, "stars": round(earned_stars, 2),
    }
...
with st.expander("⚙️  SECURE ADMINISTRATION — Vault Master Controls"):
    ...
    unlock_pw = st.text_input("Enter Vault Master Password to unlock settings", type="password", key="vault_unlock")
    
    if unlock_pw == d["admin_password"]:
        st.success("Vault Unlocked.")
        
        st.markdown('<div class="form-section-head">Manual Coin Correction</div>', unsafe_allow_html=True)
        st.info("To prevent impulsive adjustments, you must swear the Oath of Integrity.")
        ...
        oath_txt = st.text_input('Type exactly: "I am an auditor acting with integrity"', key="admin_oath")
        
        if st.button("⚡ Apply Override"):
            if oath_txt != "I am an auditor acting with integrity":
                st.error("Oath failed. Override rejected. Precision is required.")
            elif not reason_txt.strip():
        ...
        reset_pw = st.text_input("Admin Password to confirm full reset", type="password", key="reset_pw")
